...
export class ProductService implements IProductService {
  ...
  async update(id: string, name: string, value: number, amount: number, description: string, photo: string) {
    return await this.repository.findByIdAndUpdate(id, name, value, amount, description, photo);
  }
